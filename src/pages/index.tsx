  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to sondy - Empowering You to Take Surveys with Ease, Precision and Efficiency. Your Opinion Matters to Us."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to sondy - Empowering You to Take Surveys with Ease, Precision and Efficiency. Your Opinion Matters to Us.`}
            </Text>
            <Box
